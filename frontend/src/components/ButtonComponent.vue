...
<template>
    <button v-if="loading" class="flex justify-center bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-700 text-black rounded-lg p-2 px-4 font-medium min-h-[40px]">
