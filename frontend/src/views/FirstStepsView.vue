...
<template>
  <main class="bg-neutral-900 container min-h-screen flex flex-col justify-center items-center p-2 py-4">
    <p class="text-center text-white mb-8">Vamos começar personalizando o seu perfil</p>
    <div class="w-full">
        <div class="bg-neutral-800 pb-6 rounded-lg w-full max-w-xl relative mx-auto">
        ...
        <div class="mt-4 mx-auto w-full max-w-xl flex justify-end">
